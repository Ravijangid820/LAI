...
Usage:
    python -m lai.search.eval --mode dense --n 200
    python -m lai.search.eval --mode dense_prefix --n 200
    python -m lai.search.eval --mode hybrid --n 200
"""
...
#
# 2026-05-31 note: a "top-3 AND" variant was attempted to fix the ~4 s
# warm-BM25 retrieve_s flagged by the smoke test, and was reverted after a
