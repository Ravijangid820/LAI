...
Usage:
    python scripts/rag_audit_analysis.py scripts/rag_eval_results/hybrid_rerank_n500.json
"""
...
def main():
    ...
    p.add_argument("results", help="Path to rag_eval output JSON (from rag_eval.py)")
