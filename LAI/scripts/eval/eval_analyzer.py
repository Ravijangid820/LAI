...
Run:
    ...
    python scripts/eval/eval_analyzer.py [--server http://localhost:18000]
                                         [--versions 1,2]
                                         [--out scripts/eval/rag_eval_results/analyzer_compare.md]
"""
...
LAI = Path(__file__).resolve().parents[2]
GOLD_DIR = LAI / "eval" / "contracts"
DEFAULT_OUT = LAI / "scripts" / "eval" / "rag_eval_results" / "analyzer_compare.md"
