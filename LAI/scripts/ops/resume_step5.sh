...
#
# Usage:
#   ./scripts/ops/resume_step5.sh          # start (or resume) vLLM + Step 5
#   ./scripts/ops/resume_step5.sh --status # show current status
#   ./scripts/ops/resume_step5.sh --stop   # stop Step 5 (container keeps running)
#   ./scripts/ops/resume_step5.sh --stop-all  # stop Step 5 AND the container
# =============================================================================

set -u

# ---- paths ------------------------------------------------------------------
# scripts/ops/resume_step5.sh → LAI_DIR is two levels up.
